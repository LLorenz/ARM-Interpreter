...
var commandMap = (function () {
	...
	function comp(operatorBits, compOperator, firstOp, flexOpFirstPart, flexOpSecondPart) {
		...
		return {
			...
			bytecode: 0x00000000000000000000000000000000 | secondaryI << 25 | operatorBits << 21 | writeStatus << 20 | parseRegister(firstOp) << 16 | secOpEval[2] << 0
		};
	}
	[
	...
	function mov(operatorBits, movOperator, writeStatus, result, flexOpFirstPart, flexOpSecondPart) {
		...
		return {
			...
			bytecode: 0x00000000000000000000000000000000 | secondaryI << 25 | operatorBits << 21 | writeStatus << 20 | parseRegister(result) << 12 | secOpEval[2] << 0
		};
	}
